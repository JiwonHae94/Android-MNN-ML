...
extern "C" JNIEXPORT jlong JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeReleaseNet(JNIEnv *env, jobject type,
                                                                                             jlong netPtr) {
    if (0 == netPtr) {
        return 0;
    }
...
extern "C" JNIEXPORT jlong JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeCreateSession(
    JNIEnv *env, jobject type, jlong netPtr, jint forwardType, jint numThread, jobjectArray jsaveTensors,
...
extern "C" JNIEXPORT void JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeReleaseSession(JNIEnv *env,
                                                                                                        jobject type,
                                                                                                jlong netPtr,
                                                                                                jlong sessionPtr) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeRunSession(JNIEnv *env, jobject type,
                                                                                            jlong netPtr,
                                                                                            jlong sessionPtr) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
...
extern "C" JNIEXPORT jint JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeRunSessionWithCallback(
    JNIEnv *env, jobject type, jlong netPtr, jlong sessionPtr, jobjectArray nameArray, jlongArray jtensoraddrs) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeReshapeSession(JNIEnv *env,
                                                                                                        jobject type,
                                                                                                jlong netPtr,
                                                                                                jlong sessionPtr) {
    auto net     = (MNN::Interpreter *)netPtr;
...
extern "C" JNIEXPORT jlong JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeGetSessionInput(
    JNIEnv *env, jobject type, jlong netPtr, jlong sessionPtr, jstring name_) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
    if (nullptr == name_) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeGetSessionOutput(
    JNIEnv *env, jobject type, jlong netPtr, jlong sessionPtr, jstring name_) {
    auto net     = (MNN::Interpreter *)netPtr;
    auto session = (MNN::Session *)sessionPtr;
    if (nullptr == name_) {
...
extern "C" JNIEXPORT void JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeReshapeTensor(JNIEnv *env, jobject type,
                                                                                               jlong netPtr,
                                                                                               jlong tensorPtr,
                                                                                               jintArray dims_) {
...
extern "C" JNIEXPORT void JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeSetInputIntData(
    JNIEnv *env, jobject type, jlong netPtr, jlong tensorPtr, jintArray data_) {
    auto tensor = (MNN::Tensor *)tensorPtr;
...
extern "C" JNIEXPORT void JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeSetInputFloatData(
    JNIEnv *env, jobject type, jlong netPtr, jlong tensorPtr, jfloatArray data_) {
    auto tensor = (MNN::Tensor *)tensorPtr;
...
Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeTensorGetDimensions(JNIEnv *env, jobject type, jlong tensorPtr) {
    auto tensor     = (MNN::Tensor *)tensorPtr;
...
extern "C" JNIEXPORT jint JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeTensorGetUINT8Data(JNIEnv *env,
                                                                                                            jobject type,
                                                                                                    jlong tensorPtr,
                                                                                                    jbyteArray jdest) {
    auto tensor = (MNN::Tensor *)tensorPtr;
...
extern "C" JNIEXPORT jint JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeTensorGetIntData(JNIEnv *env,
                                                                                                          jobject type,
                                                                                                  jlong tensorPtr,
                                                                                                  jintArray dest) {
    auto tensor = (MNN::Tensor *)tensorPtr;
...
extern "C" JNIEXPORT jint JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeTensorGetData(JNIEnv *env, jobject type,
                                                                                               jlong tensorPtr,
                                                                                               jfloatArray dest) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_jiwon_android_1mnn_1ml_mnn_MNNNetNative_nativeConvertBufferToTensor(
    JNIEnv *env, jobject type, jbyteArray jbufferData, jint jwidth, jint jheight, jlong tensorPtr, jint srcType,
